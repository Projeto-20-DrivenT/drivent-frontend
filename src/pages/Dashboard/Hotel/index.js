    ...
    <>
      ...
      {!myBookingLoading ? hasBooking ? <MyRoom room={myBooking.Room}/> : 
        <> 
          ...
          {!ticketLoading && ticket?.status === 'PAID' && !ticket?.TicketType?.isRemote && selectedHotelId && selectedRoomId && <BookingButton onClick={handleClick}>RESERVAR QUARTO</BookingButton>}
        </>
        : ''
      }
    </>
